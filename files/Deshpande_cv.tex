...
\begin{itemize}
\item{2025: CANSSI Monte Carlo Workshop}
...
\begin{itemize}
\item{2025: Predictive Analytics in Sports (Iowa State), IISA, BNP}
...
\textbf{Ph.D. dissertation committee}: Mingya Huang, Matt Bacca, Elaine Chu, Chan Park, Peng Yu, Tun Lee Ng, Yanbo Shen, Kehui Yao, Alex Hayes, Bowen Zhang, Liam Johnston; Ryan Brill (UPenn).

\textbf{Professional organizations}

\begin{itemize}
\item{Chair, ISBA 2026 World Meeting Scientific Committee \hfill January 2025--present.}
\item{Member (Chair 2025), ISBA Program Council \hfill January 2024--present.}
\item{Associate Editor, \textit{Sankhya A} \hfill August 2025--present}
