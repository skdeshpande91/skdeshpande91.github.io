...
\begin{document}  
\name{\hspace{0.05in} Sameer K. Deshpande \\  \hspace{0.45in} February 2022}
...
Bayesian treed ensembles with new decision rules for structured categorical variables -- ISBA 202.
...
\textbf{Journal Reviewer:} Journal of the American Statistical Association, Annals of Applied Statistics, Journal of Computational and Graphical Statistics, Bayesian Analysis, Journal of Multivariate Analysis, Statistics and Computation, Journal of Quantitative Analysis in Sport, PLOS ONE, Harvard Data Science Review, STAT. 
