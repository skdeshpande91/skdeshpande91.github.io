...
\begin{document}  
\name{\hspace{0.05in} Sameer K. Deshpande \\  \hspace{0.45in} July 2021}
...
Weiss, J., Rabinowitz, A.R., \textbf{Deshpande, S.K.}, Hasegawa, R.B., and Small, D.S. (2021). ``Collision sports participation and cognitive aging among Swedish twins.'' \textit{American Journal of Epidemiology} (Accepted).

Ghosh, S., Stephenson, W.T., Nguyen, T.D., \textbf{Deshpande, S.K.}, and Broderick, T. (2020). ``Approximate cross-validation for structured models.'' \textit{NeurIPS 2020} (Accepted). \href{https://arxiv.org/abs/2006.12669}{[arXiv:200612669]}. 
