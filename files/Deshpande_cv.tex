...
\begin{document}  
\name{\hspace{0.05in} Sameer K. Deshpande \\  \hspace{0.45in} July 2020}
...
Weiss, J., Rabinowitz, A.R., \textbf{Deshpande, S.K.}, Hasegawa, R.B., and Small, D.S. (2020). ``Collision sports participation and cognitive aging among Swedish twins'' (Submitted).
...
%Estimating the health consequences of playing football using observational data: challenges, lessons learned, and new directions. Ohio State Bayesian Causal Inference Workshop 2019.

%Estimating the health consequences of playing football using observational data: challenges, lessons learned, and new directions. NESS 2019.

%Estimating the health consequences of playing football: evidence from observational studies. CMU Sports Analytics Conference 2018.
...
%Simultaneous variable and covariance selection with the multivariate spike-and-slab LASSO, Eco Sta 2018.

%Simultaneous variable and covariance selection with the multivariate spike-and-slab LASSO, BayesComp  2018.

%Simultaneous variable and covariance selection with the multivariate spike-and-slab LASSO, CMStatistics 2017.
...
%A hierarchical model of pitch framing, NESSIS 2015

Estimating an NBA player's impact on his team's chances of winning -- JSM 2014, JMM 2015

%Estimating an NBA player's impact on his team's chances of winning, JSM 2014
